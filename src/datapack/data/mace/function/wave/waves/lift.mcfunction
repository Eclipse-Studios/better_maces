...
execute as @e[tag=mace.final_point,tag=!mace.lifted] at @s run loot replace entity @s armor.head mine ~ ~ ~ netherite_pickaxe[enchantments={"minecraft:silk_touch":1}]
